...
fn main() {
    ...
    println!("cargo:rerun-if-env-changed=TANUKI_BUILD_CHANNEL");
    println!("cargo:rerun-if-env-changed=TANUKI_BUILD_ID");
    println!("cargo:rerun-if-env-changed=TANUKI_BUILD_COMMIT");
