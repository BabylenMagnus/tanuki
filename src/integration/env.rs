...
pub(crate) const TANUKI_PANE_ID_ENV_VAR: &str = "TANUKI_PANE_ID";
pub(crate) const TANUKI_TAB_ID_ENV_VAR: &str = "TANUKI_TAB_ID";
pub(crate) const TANUKI_WORKSPACE_ID_ENV_VAR: &str = "TANUKI_WORKSPACE_ID";
