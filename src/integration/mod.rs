...
const PI_EXTENSION_INSTALL_NAME: &str = "tanuki-agent-state.ts";
const PI_EXTENSION_ASSET: &str = include_str!("assets/pi/tanuki-agent-state.ts");
const PI_INTEGRATION_VERSION: u32 = 6;
const OMP_EXTENSION_INSTALL_NAME: &str = "tanuki-omp-agent-state.ts";
const OMP_EXTENSION_ASSET: &str = include_str!("assets/omp/tanuki-agent-state.ts");
const OMP_INTEGRATION_VERSION: u32 = 6;
const CLAUDE_HOOK_INSTALL_NAME: &str = if cfg!(windows) {
    "tanuki-agent-state.ps1"
} else {
    "tanuki-agent-state.sh"
};
const CLAUDE_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/claude/tanuki-agent-state.ps1")
} else {
    include_str!("assets/claude/tanuki-agent-state.sh")
};
...
const CODEX_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/codex/tanuki-agent-state.ps1")
} else {
    include_str!("assets/codex/tanuki-agent-state.sh")
};
...
const KIMI_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/kimi/tanuki-agent-state.ps1")
} else {
    include_str!("assets/kimi/tanuki-agent-state.sh")
};
const KIMI_INTEGRATION_VERSION: u32 = 5;
const KIMI_CONFIG_BLOCK_BEGIN: &str = "# >>> tanuki kimi integration";
const KIMI_CONFIG_BLOCK_END: &str = "# <<< tanuki kimi integration";
...
const COPILOT_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/copilot/tanuki-agent-state.ps1")
} else {
    include_str!("assets/copilot/tanuki-agent-state.sh")
};
...
const DEVIN_HOOK_INSTALL_NAME: &str = "tanuki-agent-state.sh";
const DEVIN_HOOK_ASSET: &str = include_str!("assets/devin/tanuki-agent-state.sh");
...
const DROID_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/droid/tanuki-agent-state.ps1")
} else {
    include_str!("assets/droid/tanuki-agent-state.sh")
};
...
const OPENCODE_PLUGIN_INSTALL_NAME: &str = "tanuki-agent-state.js";
const OPENCODE_PLUGIN_ASSET: &str = include_str!("assets/opencode/tanuki-agent-state.js");
const OPENCODE_INTEGRATION_VERSION: u32 = 9;
const KILO_PLUGIN_INSTALL_NAME: &str = "tanuki-agent-state.js";
const KILO_PLUGIN_ASSET: &str = include_str!("assets/kilo/tanuki-agent-state.js");
const KILO_INTEGRATION_VERSION: u32 = 3;
const HERMES_PLUGIN_INSTALL_NAME: &str = "tanuki-agent-state";
...
const QODERCLI_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/qodercli/tanuki-agent-state.ps1")
} else {
    include_str!("assets/qodercli/tanuki-agent-state.sh")
};
...
const CURSOR_HOOK_INSTALL_NAME: &str = "tanuki-agent-state.sh";
const CURSOR_HOOK_ASSET: &str = include_str!("assets/cursor/tanuki-agent-state.sh");
const CURSOR_INTEGRATION_VERSION: u32 = 1;
const MASTRACODE_HOOK_INSTALL_NAME: &str = "tanuki-agent-state.sh";
const MASTRACODE_HOOK_ASSET: &str = include_str!("assets/mastracode/tanuki-agent-state.sh");
...
const INTEGRATION_VERSION_MARKER: &str = "TANUKI_INTEGRATION_VERSION=";
